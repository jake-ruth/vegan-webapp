...
ApplicationUserController.readOneApplicationUser = (id) => __awaiter(void 0, void 0, void 0, function* () {
    return yield ApplicationUser_1.ApplicationUser.findOne(id);
});
...
ApplicationUserController.generateAccessToken = (user) => __awaiter(void 0, void 0, void 0, function* () {
    return yield jwt.sign(user, process.env.ACCESS_TOKEN_SECRET, { expiresIn: '30m' });
});
